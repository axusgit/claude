...
def headsup(fn):
    ...
    html = _shell(f"""
      <h1 style="margin:12px 0 6px;font-size:20px;">A better support experience is coming</h1>
      <p style="margin:10px 0 0;font-size:14.5px;line-height:1.6;color:#3a4150;">Hi {n},</p>
      <p style="margin:10px 0 0;font-size:14.5px;line-height:1.6;color:#3a4150;">As part of our commitment to faster, more reliable service, Axus Technologies is moving to a new support portal, going live <strong>Monday, September 28, 2026</strong>.</p>
      <p style="margin:16px 0 4px;font-size:14.5px;line-height:1.6;color:#3a4150;"><strong>What's changing</strong></p>
      ...
      <p style="margin:4px 0 0;font-size:14.5px;line-height:1.6;color:#3a4150;">Nothing before Monday. We'll email you everything you need to sign in and get started. From Monday, please use the new portal for all support requests; our previous system will be retired.</p>
    ...
    """)
    text = (f"Hi {fn},\n\n"
            "As part of our commitment to faster, more reliable service, Axus Technologies is moving to a new "
            "support portal, going live Monday, September 28, 2026.\n\n"
            "What's changing\n"
            ...
            "What you need to do\n"
            "Nothing before Monday. We'll email you everything you need to sign in and get started. "
            "From Monday, please use the new portal for all support requests; our previous system will be retired.\n\n"
