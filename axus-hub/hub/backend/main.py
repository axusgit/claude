...
APP_CATALOG = [
    ...
    {"key": "order", "name": "Readiness Order", "desc": "HCN IT hardware ordering & budgetary quotes", "group": "app-order", "icon": "🛒", "internal": False, "url": "https://rorder.axustechnologies.com", "health": "https://rorder.axustechnologies.com/api/health"},
